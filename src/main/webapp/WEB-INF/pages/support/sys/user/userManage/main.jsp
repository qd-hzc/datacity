...
<script type="text/javascript" src="<%=request.getContextPath()%>/City/support/sys/user/userManage/userAddWin.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/City/support/sys/user/userManage/userModify.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/City/support/sys/user/userManage/catUserWin.js"></script>
