 ...
 */
Ext.define('Ext.areaManageAddSameWin', {
    extend: 'Ext.window.Window',
    height: 470,
    width: 380,
    modal: true
});
Ext.areaManageAddSameWin.show = function (rec, fnt) {// 两个参数，fnt是回调函数，rec是record，可以自定义。
...
//            allowBlank: false,
    ...
    var areaManageAddSameWin = Ext.create('Ext.areaManageAddSameWin', {
        title: '添加同级区域',
        frame: false,
        border: false,
        layout: 'border',
