 ...
 * 添加指标分组
 */
createModel('Ext.addItemGroupWin', function () {
    Ext.define('Ext.addItemGroupWin', {
 ...
 * @returns {Ext.addItemGroupWin}
 */
Ext.addItemGroupWin.init = function (isAdd, node) {
    ...
    var win = new Ext.addItemGroupWin({
        items: [form],
        buttons: [{
            text: '保存',
            handler: function () {
