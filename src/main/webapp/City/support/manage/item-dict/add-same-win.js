 ...
 */
Ext.define('Ext.itemDictManageAddSameWin', {
    extend: 'Ext.window.Window',
    height: 320,
    width: 380,
    modal: true
});
Ext.itemDictManageAddSameWin.show = function (rec, fnt) {// 两个参数，fnt是回调函数，rec是record，可以自定义。
    ...
    var itemDictManageAddSameWin = Ext.create('Ext.itemDictManageAddSameWin', {
        title: '添加同级目录',
        frame: false,
        border: false,
        layout: 'border',
                    ...
                    formPanel.getForm().submit({
                        ...
                        success: function (form, action) {
                            ...
                            Ext.Msg.alert('提示', msg,
                                function (id) {
                                    if ('ok' == id) {
                                        itemDictManageAddSameWin.close();
